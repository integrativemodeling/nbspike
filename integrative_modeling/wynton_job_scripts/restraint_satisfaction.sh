...
CLUSTER_DIR=$1/analysis/analysis_$i/clusters
OUTDIR=$1/analysis/analysis_$i/restraint_sat

# run restraint satisfaction
$IMPENV python restraint_satisfaction.py -nb $1 -r $RMF_FILE -d ./data -c $CLUSTER_DIR -o $OUTDIR -n 20
